...
from src.config import TCP, UDP, DEFAULT_NUM_THREADS, SIZE_BYTE
...
class SocketDos():
    ...
    def tcp_flood(self):
        try:
            while True:
                ...
                bytes_to_send = random._urandom(self.size_bytes)
    ...
    def udp_flood(self):
        ...
        bytes_to_send = random._urandom(self.size_bytes)  # random bytes
        while True:
